...
namespace VotingSystem.Commands
{
    ...
    class blackout2 : ICommand
    {
        public string Command { get; } = "BlackoutMedium";

        public string[] Aliases { get; } = { "blackoutmed" };
        ...
        {
            Exiled.API.Features.Map.TurnOffAllLights(30f, false);
        }
    }
}
